...
function readConfig() {
  const defaults = {
    ...
    subtitle_display_config: '{"preview":{"positionMode":"fixed","positionFixed":"bottom","positionPercent":80,"fontSize":14},"fullscreen":{"positionMode":"fixed","positionFixed":"bottom","positionPercent":80,"fontSize":32},"export":{"positionMode":"percentage","positionFixed":"bottom","positionPercent":80}}',
  };
